...
Public Class Form2
    ...
    Private Sub btCrearNewUser_Click(sender As Object, e As EventArgs) Handles btCrearNewUser.Click
        ...
        Dim InsertSql = "INSERT INTO " & "RegistroUS" & "(Nombre, Apellidos, NumID, Email, Telefono, Contrasena, ConfirContra)" & "VALUES" & "(@Nombre, @Apellidos, @NumID, @Email, @Telefono, @Contrasena, @ConfirContra)"
